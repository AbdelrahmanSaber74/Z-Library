...
<body>
    ...
    <!-- Navbar Section Ends Here -->
    <!-- Library sEARCH Section Starts Here -->
    ...
    <!-- Library sEARCH Section Ends Here -->


    <!-- Library MEnu Section Starts Here -->
    <section class="food-menu">
        <div class="container"> 
        <h2 class="text-center">Kids Books Here </h2>
    ...
    <!-- Library Menu Section Ends Here -->
